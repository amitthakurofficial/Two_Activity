    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String s1=name1.getText().toString().trim();
                ...
                {
                    Intent sendmessage=new Intent(MainActivity.this,Main2Activity.class);
                    sendmessage.putExtra("name",s1);
                    sendmessage.putExtra("message",s2);
